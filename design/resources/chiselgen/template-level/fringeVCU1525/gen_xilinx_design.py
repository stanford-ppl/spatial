...
# spatial_top.sv
src = open(design_dir + 'spatial_top.sv_TEMPLATE')
dst = open(design_dir + 'spatial_top.sv', 'w')
for line in src:
...
for line in src:
  if '{{{SPATIAL_INSERT_input_argnum}}}' in line:
    ...
    for argnum in range(num_scalar_in):
      ...
      hex_addr = str(hex(argnum*64 + 4096*5))[2:]
      ...
      hex_addr_plus_0x20 = str(hex(argnum*64 + 32 + 4096*5))[2:]
