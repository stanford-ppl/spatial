...
object globals {
  ...
  var axiStreamInsInfo: List[AXI4BundleParameters] = Nil
  var axiStreamOutsInfo: List[AXI4BundleParameters] = Nil
  ...
  def AXI_STREAMS_IN: List[AXI4BundleParameters] = if (axiStreamInsInfo.isEmpty) List(AXI4BundleParameters(32,256,8)) else axiStreamInsInfo
  def AXI_STREAMS_OUT: List[AXI4BundleParameters] = if (axiStreamOutsInfo.isEmpty) List(AXI4BundleParameters(32,256,8)) else axiStreamOutsInfo
