...
//  val avalonBurstParams = new AvalonBundleParameters(ADDR_WIDTH, 512, 32)
  ...
  val axiParams = new AXI4BundleParameters(32, 512, 17)
  ...
  val TOP_AXI = new AXI4Probe(axiParams)
  val DWIDTH_AXI = new AXI4Probe(axiParams)
  val PROTOCOL_AXI = new AXI4Probe(axiParams)
  val CLOCKCONVERT_AXI = new AXI4Probe(axiParams)
}
