...
// 
  ...
  def crudeEstimateMem(prop: String, nodetype: String, dims: Seq[Int], bitWidth: Int, depth: Int, B: Seq[Int], N: Seq[Int], alpha: Seq[Int], P: Seq[Int], histRaw: Seq[Int]): Double = {
  ...
  def estimateMem(prop: String, nodetype: String, dims: Seq[Int], bitWidth: Int, depth: Int, B: Seq[Int], N: Seq[Int], alpha: Seq[Int], P: Seq[Int], histRaw: Seq[Int]): Double = {
    ...
    } else crudeEstimateMem(prop, nodetype, dims, bitWidth, depth, B, N, alpha, P, histRaw)
  }
