...
/** Alias from Sparse DRAM to Dense DRAM
  *
  * Getter:  sym.isMemReduceAccum
  * Setter:  sym.setMemReduceAccum
  * Default: None
  */
case class MemReduceAccum(isMemReduceAccum: Boolean) extends Data[MemReduceAccum](SetBy.Analysis.Self)
