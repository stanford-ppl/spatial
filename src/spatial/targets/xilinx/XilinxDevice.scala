...
abstract class XilinxDevice extends HardwareTarget {
  ...
  protected def makeAreaModel: AreaModel = new XilinxAreaModel
  protected def makeLatencyModel: LatencyModel = new LatencyModel
