...
@spatial class FFT_Transpose_1 extends SpatialTest {
 /*                                                                                                  
 ...
 */
  ...
  def main(args: Array[String]): Unit = {
    ...
    Accel{
      val work_x_sram = SRAM[T](8,stride).flat.effort(0)
      val work_y_sram = SRAM[T](8,stride).flat.effort(0)
...
@spatial class FFT_Transpose_2 extends SpatialTest {
 /*                                                                                                  
    Concerns: Not sure why machsuite makes a data_x and DATA_x when they only dump values from one row of DATA_x to data_x and back
              Also, is their algorithm even correct?!  It's very suspicion and I can even comment out some of their code and it still passes....
 */
  ...
  def main(args: Array[String]): Unit = {
    ...
    Accel{
      val work_x_sram = SRAM[T](8,stride).flat.axesfission(List(List(0,1))).effort(0)
      val work_y_sram = SRAM[T](8,stride).flat.axesfission(List(List(0,1))).effort(0)
      val smem = SRAM[T](8*8*9)
...
@spatial class FFT_Transpose_3 extends SpatialTest {
 /*                                                                                                  
    Concerns: Not sure why machsuite makes a data_x and DATA_x when they only dump values from one row of DATA_x to data_x and back
              Also, is their algorithm even correct?!  It's very suspicion and I can even comment out some of their code and it still passes....
 */
  ...
  def main(args: Array[String]): Unit = {
    ...
    Accel{
      val work_x_sram = SRAM[T](8,stride).hierarchical.effort(0)
      val work_y_sram = SRAM[T](8,stride).hierarchical.effort(0)
      val smem = SRAM[T](8*8*9)
...
@spatial class FFT_Transpose_4 extends SpatialTest {
 /*                                                                                                  
    Concerns: Not sure why machsuite makes a data_x and DATA_x when they only dump values from one row of DATA_x to data_x and back
              Also, is their algorithm even correct?!  It's very suspicion and I can even comment out some of their code and it still passes....
 */
  ...
  def main(args: Array[String]): Unit = {
    ...
    Accel{
      val work_x_sram = SRAM[T](8,stride).hierarchical.axesfission(List(List(0,1))).effort(0)
      val work_y_sram = SRAM[T](8,stride).hierarchical.axesfission(List(List(0,1))).effort(0)
      val smem = SRAM[T](8*8*9)
