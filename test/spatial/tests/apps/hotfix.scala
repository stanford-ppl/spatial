...
@spatial class hotfix extends SpatialTest {
  def main(args: Array[String]): Unit = {

    Accel {
      val aMem = SRAM[Int](16).onlyblockcyclic.nRelaxed
...
@spatial class AccumType152 extends SpatialTest {
  def main(args: Array[String]): Unit = {
    val vecLen = 4
    val n = 128
    val k = 64
