...
//     val imgOut  = StreamOut[Pixel16](target.VGA)//BufferedOut[Pixel16](target.VGA)
...
//           val grayPixel = Pixel16(grayVal.bits(5::1).as[UInt5], grayVal.bits(5::0).as[UInt6], grayVal.bits(5::1).as[UInt5])
...
//           imgOut := Pixel16(pixel.b, pixel.g, pixel.r)
//         }
//       }
//     }
//   }
